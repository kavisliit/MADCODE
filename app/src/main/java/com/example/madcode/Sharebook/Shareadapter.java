...
public class Shareadapter extends RecyclerView.Adapter<Shareadapter.MyViewHolder>{
    ...
    public Shareadapter(Context context, ArrayList<Modelshare> list, RecyclerViewClickListner listner) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull Shareadapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
