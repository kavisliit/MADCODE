...
public class Req_adapter extends RecyclerView.Adapter<Req_adapter.MyViewHolder>{
    ...
    public Req_adapter(Context con, ArrayList<reqmodal> list, RecyclerViewClickListner listner) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull Req_adapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
